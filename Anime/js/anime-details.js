      ...
      function updateStream(providerIndex = 0) {
        ...
        try {
          if (provider === "vidsrc") {
            ...
            src = `https://player.videasy.net/tv/${window.tmdbId}/1/${ep}${dub === "true" ? "?dub=true&autoplay=1" : "?autoplay=1"}`;
          } else if (provider === "vidsrc-icu") {
            const dubFlag = dub === "true" ? "1" : "0";
            src = `https://vidsrc.icu/embed/anime/${anime.mal_id}/${ep}/${dubFlag}/1?autoplay=1`;
            ...
            src = `https://player.videasy.net/anime/${anime.mal_id}/${ep}${dub === "true" ? "?dub=true&autoplay=1" : "?autoplay=1"}`;
          }
